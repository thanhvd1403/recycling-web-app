  ...
  return (
   ...
   < div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
      ...
      <div class="flex justify-center">
        <a href="https://www.linkedin.com/in/phi-dung-ho/" class="mr-6 text-white">
        ...
        <a href="https://github.com/PhiDung-hub/cz2006_web_app" class="text-white">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid grid-1 md:grid-cols-1 lg:grid-cols-4 gap-4">
        <div class="col-span-2">
          ...
          <p>
            Torwards a greener country, transforming Singapore through Technology!
          </p>
        </div>
        ...
        <div class="">
          ...
          <p class="mb-4">
            <a href="info_page" class="text-white">E-waste Information</a>
          </p>
          <p class="mb-4">
            <a href="recycling_page" class="text-white">Recycling Hub</a>
          </p>
          <p class="mb-4">
            <a href="events_page" class="text-white">Events</a>
          </p>
        </div>
