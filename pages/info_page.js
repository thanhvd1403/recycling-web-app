        ...
        <section>
          <div class="flex">
            ...
            <div class="flex-initial w-640">
              <div id="DoE" class="space-x-7 py-10 pl-10 pr-10 text-center">
                Definition of E-waste
                <div class="w-full text-center pl-5 pr-5 py-20 rounded-full border-3 border-yellow-600 bg-green-300">
                  Electronic waste or e-waste describes discarded electrical or
                  electronic devices. Used electronics which are destined for
              ...
              <div id="ToE" class="flex space-x-7 py-10 pl-10 pr-10">
                <div class="flex-initial w-1/2 text-center pl-5 pr-5 py-20 rounded-lg border-3 border-red-500 bg-green-300">
                  ICT Equipment means any radio and telecommunication equipment
                  or combination of equipment capable of effecting radio
                  communications or telecommunications, whether by transmission
                  or reception of radio and telecommunications.
                </div>
                <div class="flex-initial w-1/2 text-center pl-5 pr-5 py-20 rounded-lg border-3 border-red-500 bg-green-300">
